...
class AmongSprite {
    ...
    create = async (resolution=600, playerColor, bgName, hatName = undefined, outfitName = undefined, petName = undefined, impostor = false, ...overlays) => {
        if (bgName===undefined || playerColor===undefined)
            throw new ReferenceError('Background and Player Color must not be undefined.');

        const basePlayer = impostor ? `./assets/PLAYER/BASE_IMPOSTOR.png` : `./assets/PLAYER/BASE.png`;
